...
The P3can project precedes the `tribology` package and many of its functions
and functionalities have since been integrated into the package. This work will
...
For more information on the `p3can` project, please see here:
...
def p3can(in_file='USER_INPUT.py', out_dir=os.getcwd()):
    """
    ...
    out_dir: str
        ...
        contains a simulation-specific folder containing all outputs.
...
def generate_input_file(temp_type, out_file):
    ...
    temp_type: int
        ...
        3:  template for cylindircal roller thrust bearings
