...
length_cb1 = 10  # in mm
type_profile_cb1 = 'File'  # 'None', 'ISO', 'Circle', 'File'
path_profile_cb1 = 'BearingProfiles/NU206-RE-1.txt'  # path to profile.txt file required if TypeProfile == 'File'
profile_radius_cb1 = 6.35  # input required if TypeProfile == 'Circle'
roller_slip = "RollerSlip/testslip.txt"
...
length_cb2 = 10
path_profile_cb2 = "BearingProfiles/NU206-IR-2.txt"  # path to profile.txt file required if TypeProfile == 'File'
...
path_profile_cb3 = "BearingProfiles/NU2208-IR-1.txt"  # path to profile.txt file required if TypeProfile == 'File'
...
# Mesh
res_x = 31  # data points along roller length
res_y = 31  # data points along roller width
res_pol = 130  # data points along bearing circumference
